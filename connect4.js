...
function reportWin(rowInd,colInd) {
...
function changeColor(rowInd, colInd, color){
  ...
  table.eq(rowInd).find('td').eq(colInd).find('button').css('background-color',color);
}
...
function checkBottom(colInd){
  var colorReport = returnColor(5, colInd);
  for(var rowInd = 5; rowInd> -1; rowInd--){
    colorReport = returnColor(rowInd,colInd);
